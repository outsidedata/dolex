...
export declare function executeJsAggregation(source: ConnectedSource, table: string, query: DslQuery, dialect?: 'sqlite'): Promise<DslQueryResult>;
export declare function executeJsAggregationWithWindows(source: ConnectedSource, table: string, query: DslQuery, dialect?: 'sqlite'): Promise<DslQueryResult>;
