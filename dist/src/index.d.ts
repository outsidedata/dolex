 ...
 */
export type { DataColumn, DataTable, ForeignKey, DataSchema, DataSourceType, DataSourceInfo, DataSourceConfig, PatternCategory, DataRequirements, SelectionRule, PatternMatchContext, VisualizationPattern, VisualizationSpec, AxisEncoding, ColorEncoding, SizeEncoding, VisualizationRecommendation, VisualizeInput, VisualizeOutput, RefineInput, RefineOutput, CompoundVisualizationSpec, CompoundView, TableViewSpec, TableColumn, CompoundLayout, Interaction, DslJoin, DslQuery, DslSelectField, DslAggregateField, DslWindowFunction, DslWindowField, DslGroupByField, DslFilter, DslFilterOp, DslOrderBy, DslAggregate, SourceDataRef, DashboardSpec, DashboardViewSpec, DashboardFilter, DashboardLayout, DashboardInteraction, } from './types.js';
