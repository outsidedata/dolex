 ...
 */
export type { DataColumn, DataTable, ForeignKey, DataSchema, DataSourceType, DataSourceInfo, DataSourceConfig, PatternCategory, DataRequirements, SelectionRule, PatternMatchContext, VisualizationPattern, VisualizationSpec, AxisEncoding, ColorEncoding, SizeEncoding, VisualizationRecommendation, VisualizeInput, VisualizeOutput, RefineInput, RefineOutput, CompoundVisualizationSpec, CompoundView, TableViewSpec, TableColumn, CompoundLayout, Interaction, RowFilter, RowFilterOp, } from './types.js';
