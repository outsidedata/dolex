...
import { inferColumns, applyColorPreferences, buildOutputHtml, resolveData, isErrorResponse, } from './shared.js';
...
export function handleVisualize(selectPatterns, deps) {
