...
export const barPattern = {
    ...
    name: 'Bar Chart',
    category: 'comparison',
    description: 'Standard vertical bar chart for comparing values across categories. The reliable default for categorical comparison.',
    bestFor: 'Simple categorical comparison with 3-15 categories and one value metric.',
    notFor: 'Time series (use line), part-to-whole (use waffle/stacked), distribution (use histogram/beeswarm), rank changes (use bump chart).',
    dataRequirements: {
        minRows: 2,
        maxRows: 50,
        requiredColumns: [
