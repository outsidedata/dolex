 ...
 */
export const groupedBarPattern = {
    id: 'grouped-bar',
    name: 'Grouped Bar Chart',
    category: 'comparison',
    description: 'Side-by-side bars for comparing multiple metrics or series across categories. Nested groups with color-coded series.',
    bestFor: 'Direct comparison of 2-4 metrics per category: revenue vs cost by department, male vs female enrollment by year, Q1 vs Q2 sales by product.',
    notFor: 'Single metric (use bar), part-to-whole (use stacked-bar), >5 series (too many bars per group), time series (use line).',
    dataRequirements: {
        minRows: 4,
        maxRows: 100,
        requiredColumns: [
