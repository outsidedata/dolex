...
export const donutPattern = {
    ...
    description: 'Circular part-to-whole chart with a hollow center showing category proportions as arc segments. The classic pie/donut.',
    bestFor: 'Simple part-to-whole with 2-6 categories. Budget breakdown, market share, survey responses, vote share, portfolio allocation.',
    notFor: 'More than 8 categories (slices become unreadable). Small differences between slices (hard to compare angles). Showing change over time. Precise value comparison.',
    dataRequirements: {
        minRows: 2,
        maxRows: 8,
        requiredColumns: [
    ...
    selectionRules: [
        ...
        },
        {
            ...
            weight: 45,
            matches: (ctx) => {
                return /\b(percent|proportion|share|part.of|makeup|how\s+much\s+of|breakdown)\b/i.test(ctx.intent);
            },
        },
        {
