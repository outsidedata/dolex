 ...
 */
export const marimekkoPattern = {
    id: 'marimekko',
    name: 'Marimekko Chart',
    category: 'composition',
    description: 'Two-dimensional stacked bar where both bar width and segment height encode data. Width represents one category\'s proportion of the total, height represents another category\'s proportion within each bar. Also known as a mosaic or mekko chart.',
    bestFor: 'Market share by segment AND region, revenue by product AND channel, population by age AND country. Two-dimensional part-to-whole where both dimensions matter.',
    notFor: 'Single dimension (use stacked-bar or waffle instead). More than 6 categories on either axis. Precise value comparison where small differences matter.',
    dataRequirements: {
        minRows: 4,
        maxRows: 200,
        requiredColumns: [
