 ...
 */
export const stackedBarPattern = {
    id: 'stacked-bar',
    name: 'Stacked Bar Chart',
    category: 'composition',
    description: 'Bars divided into colored segments, showing both total values and their composition. Each segment represents a subcategory contribution.',
    bestFor: 'Showing how a total breaks down into parts across categories. Revenue by product by region, population by age group by country.',
    notFor: 'Comparing individual segment values across bars (hard to compare non-baseline segments). Use grouped bar for precise comparison of parts.',
    dataRequirements: {
        minRows: 4,
        maxRows: 200,
        requiredColumns: [
    ...
    selectionRules: [
        ...
        },
        {
            ...
            weight: 45,
            matches: (ctx) => {
                return /\b(breakdown|stacked|composed|composition|made\s+up|constitut|contribution|split\s+by)\b/i.test(ctx.intent);
            },
        },
        {
