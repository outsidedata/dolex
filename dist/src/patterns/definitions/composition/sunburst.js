...
export const sunburstPattern = {
    ...
    description: 'Concentric rings where each ring represents a level of hierarchy. Inner rings are parents, outer rings are children. Arc angle encodes proportion.',
    bestFor: 'Multi-level hierarchies (3+ levels): org charts with budget, file system usage, taxonomy breakdowns, nested categories.',
    notFor: 'Flat data (use waffle), two levels only (treemap is simpler), precise value comparison (arc angles are hard to read).',
    dataRequirements: {
        minRows: 6,
        maxRows: 300,
        requiredColumns: [
