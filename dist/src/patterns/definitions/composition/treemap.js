 ...
 */
export const treemapPattern = {
    id: 'treemap',
    name: 'Treemap',
    category: 'composition',
    description: 'Nested rectangles where area represents value. Shows hierarchical composition: total → groups → subgroups. Space-efficient for many items.',
    bestFor: 'Hierarchical data with size values: file system usage, organizational budgets, market cap by sector and company, product category revenue.',
    notFor: 'Non-hierarchical flat data (use waffle), comparing exact values (hard to compare rectangle areas), time series.',
    dataRequirements: {
        minRows: 4,
        maxRows: 500,
        requiredColumns: [
