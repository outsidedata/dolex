 ...
 */
export const wafflePattern = {
    id: 'waffle',
    name: 'Waffle Chart',
    category: 'composition',
    description: 'A 10x10 grid of colored squares, each representing 1% of the total. More perceptually accurate than pie charts for showing proportions.',
    bestFor: 'Part-to-whole comparisons with 2-8 categories. Percentage breakdowns. Survey results. Market share. Election results.',
    notFor: 'Many categories over 8 (too many colors). Very small differences (hard to see 1% vs 2%). Non-percentage data (requires total context).',
    dataRequirements: {
        minRows: 2,
        maxRows: 8,
        requiredColumns: [
    ...
    selectionRules: [
        {
            ...
            weight: 40,
            matches: (ctx) => {
                return (ctx.dataShape.categoryCount >= 2 &&
        ...
        },
        {
            ...
            weight: 60,
            matches: (ctx) => {
                return /\b(percent|proportion|share|part.of|makeup|pie|waffle|how\s+much\s+of)\b/i.test(ctx.intent);
            },
        },
        {
