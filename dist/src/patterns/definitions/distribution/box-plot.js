 ...
 */
export const boxPlotPattern = {
    id: 'box-plot',
    name: 'Box Plot',
    category: 'distribution',
    description: 'Quartile summary showing median, Q1/Q3 box, whiskers, and outliers. Compact distribution comparison across groups.',
    bestFor: 'Comparing distributions across 2-12 groups with a compact summary. Salary by department, test scores by school, response times by endpoint.',
    notFor: 'Single group with no comparison (use histogram). Showing distribution shape detail (use violin). Very few data points per group under 5.',
    dataRequirements: {
        minRows: 10,
        requiredColumns: [
