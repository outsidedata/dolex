 ...
 */
export const densityPlotPattern = {
    id: 'density-plot',
    name: 'Density Plot',
    category: 'distribution',
    description: 'Smooth continuous curve showing probability density using kernel density estimation (KDE). Reveals distribution shape without binning artifacts.',
    bestFor: 'Visualizing the shape of a continuous distribution. Comparing 2-4 overlapping distributions. Finding multimodal patterns, skewness, and tails.',
    notFor: 'Small samples under 20 data points. Discrete or categorical data. More than 5 overlapping distributions (too much overplotting).',
    dataRequirements: {
        minRows: 20,
        requiredColumns: [
