 ...
 */
export const histogramPattern = {
    id: 'histogram',
    name: 'Histogram',
    category: 'distribution',
    description: 'Bins continuous data into intervals and shows frequency of each bin. Reveals distribution shape: normal, skewed, bimodal, uniform.',
    bestFor: 'Understanding the shape of a single numeric variable: salary distribution, age distribution, response time distribution.',
    notFor: 'Categorical data (use bar), very small datasets under 20 rows (use strip plot), comparing distributions across groups (use violin or ridgeline).',
    dataRequirements: {
        minRows: 20,
        requiredColumns: [
