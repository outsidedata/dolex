 ...
 */
export const stripPlotPattern = {
    id: 'strip-plot',
    name: 'Strip Plot',
    category: 'distribution',
    description: 'Individual data points plotted along a single axis with minimal jitter. The simplest distribution view for small datasets where every point matters.',
    bestFor: 'Small datasets (5-50 rows), comparing distributions across groups when sample size is too small for density estimation.',
    notFor: 'Large datasets over 100 (points overlap — use histogram or beeswarm), complex distribution analysis (use violin).',
    dataRequirements: {
        minRows: 3,
        maxRows: 100,
        requiredColumns: [
