 ...
 */
export const radarPattern = {
    id: 'radar',
    name: 'Radar Chart',
    category: 'relationship',
    description: 'Radial axes extending from a center point, one per variable. Each entity forms a polygon. The shape reveals strengths, weaknesses, and overall profile.',
    bestFor: 'Comparing 1-3 entity profiles across 5-10 dimensions: player stat comparison, product feature comparison, skill assessment, balanced scorecard.',
    notFor: 'Many entities over 4 (polygons overlap), many dimensions over 12 (too dense), precise value comparison (radial distorts area).',
    dataRequirements: {
        minRows: 1,
        maxRows: 12,
        requiredColumns: [
    ...
    selectionRules: [
        ...
        },
        {
            ...
            weight: 60,
            matches: (ctx) => {
                return /\b(profile|strength|weakness|radar|spider|skill|balanced|assessment|scorecard|attribute|stat|characteristic)\b/i.test(ctx.intent);
            },
        },
        {
            ...
            weight: 50,
            matches: (ctx) => {
                return (ctx.dataShape.rowCount === 2 &&
