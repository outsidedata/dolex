export const horizonChartPattern = {
    id: 'horizon-chart',
    name: 'Horizon Chart',
    category: 'time',
    description: 'Ultra-compact time series that folds the y-axis into color bands, layering positive values and mirroring negatives. Shows many series in very little vertical space.',
    bestFor: 'Dashboard monitoring of 10-50+ time series simultaneously. Server metrics, stock prices, sensor readings. When you need to spot anomalies across many series at once.',
    notFor: 'Precise value reading, unfamiliar audiences (requires learning), fewer than 5 series.',
    dataRequirements: {
        minRows: 10,
        requiredColumns: [
