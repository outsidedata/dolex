 ...
 * evolution over time.
 */
export const streamGraphPattern = {
    id: 'stream-graph',
    name: 'Stream Graph',
    category: 'time',
    description: 'Stacked area chart with a flowing, organic baseline (centered or wiggle layout). Layers flow around a central axis, emphasizing how composition evolves over time.',
    bestFor: 'Showing how composition evolves over time with an emphasis on flow and organic shape. Music genre popularity over decades, topic trends over time, seasonal patterns by category.',
    notFor: 'Precise value reading (wiggle offset makes y values meaningless). Few series (<3). Non-temporal data.',
    dataRequirements: {
        minRows: 6,
        requiredColumns: [
