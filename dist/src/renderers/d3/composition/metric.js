...
// ─── VALUE FORMATTING ────────────────────────────────────────────────────────
function formatMetricValue(value, format, abbreviate, prefix, suffix) {
    let formatted;
    switch (format) {
        case 'currency':
...
// ─── GRID COLUMNS ────────────────────────────────────────────────────────────
function gridColumns(count, configColumns) {
...
// ─── ADAPTIVE SIZING ────────────────────────────────────────────────────────
function adaptiveValueSize(count, containerWidth, containerHeight) {
...
function adaptiveLabelSize(valueFontSize) {
    return Math.max(10, Math.round(valueFontSize * 0.22));
}
// ─── RENDERER ────────────────────────────────────────────────────────────────
export function renderMetric(container, spec) {
  ...
  `;
    ...
    `;
        ...
        if (prevValue !== null && !isNaN(prevValue)) {
            ...
            const deltaColor = delta.direction === 'up' ? '#10b981'
