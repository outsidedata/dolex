...
function drawLinks(g, links, colorScale, linkOpacity, tooltip) {
    const linkPath = (link) => {
    ...
    g.selectAll('.sankey-link')
        ...
        .attr('d', linkPath)
        .attr('fill', (d) => colorScale(d.source.name))
...
function drawNodes(g, nodes, colorScale, dims, tooltip) {
...
function drawNodeLabels(g, nodes, config, dims) {
