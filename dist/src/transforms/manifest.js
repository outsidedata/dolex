...
export function resolveManifestPath(config) {
...
export function writeManifest(metadata, tables, manifestPath) {
...
export function replayManifest(db, metadata, manifest, tableName) {
