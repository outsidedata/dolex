 ...
 */
export { measureText, truncateLabel, abbreviate, avoidCollisions, labelStrategy, } from './labels.js';
export type { LabelPosition, ResolvedLabel, LabelStrategyMode, LabelStrategyResult, } from './labels.js';
