 ...
 */
export function truncateLabel(text, maxWidth, fontSize = 12, ellipsis = '…') {
 ...
 */
export function avoidCollisions(labels, fontSize = 12, padding = 2, bounds) {
 ...
 */
export function labelStrategy(labels, availableWidth, fontSize = 12) {
