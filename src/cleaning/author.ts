 ...
 */
export interface AuthorRequest { column: string; issue: string; task: string; samples: string[]; feedback?: string }
...
export function buildAuthorPrompt(req: AuthorRequest): { system: string; user: string } {
