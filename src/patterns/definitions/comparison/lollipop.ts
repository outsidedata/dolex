...
export const lollipopPattern: VisualizationPattern = {
  id: 'lollipop',
  name: 'Lollipop Chart',
  category: 'comparison',
  description:
    'Dots on sticks — a thin line from baseline to a dot at the data value. Like a bar chart with less ink, cleaner for many categories.',
  bestFor:
    'Ranking and comparison with many categories (10-40). Cleaner than bars when there are many items. Dot emphasis makes values easier to read.',
  notFor:
    'Few categories (<5, just use bar), composition or part-to-whole, time series data.',
