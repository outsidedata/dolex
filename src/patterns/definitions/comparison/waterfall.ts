...
export const waterfallPattern: VisualizationPattern = {
  id: 'waterfall',
  name: 'Waterfall Chart',
  category: 'comparison',
  description:
    'Floating bars showing how an initial value is affected by sequential positive and negative intermediate values to reach a final total.',
  bestFor:
    'Financial breakdowns (revenue → costs → profit), variance analysis (budget → actuals), bridge charts showing contributing factors.',
  notFor:
    'Non-sequential data, simple comparison across categories, time series, part-to-whole.',
