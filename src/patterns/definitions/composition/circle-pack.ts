...
export const circlePackPattern: VisualizationPattern = {
  id: 'circle-pack',
  name: 'Circle Pack',
  category: 'composition',
  description:
    'Nested circles where area represents value. Shows hierarchical composition with an organic, visually distinct layout. Good alternative to treemap for fewer items.',
  bestFor:
    'Hierarchical data with size values: organizational budgets, market cap by sector, product categories. Best with fewer items than treemap since circles waste more space.',
  notFor:
    'Many small items (circles waste space vs rectangles), exact value comparisons (hard to compare circle areas), time series.',
