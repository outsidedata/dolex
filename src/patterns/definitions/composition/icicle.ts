...
export const iciclePattern: VisualizationPattern = {
  id: 'icicle',
  name: 'Icicle Chart',
  category: 'composition',
  description:
    'Linear (rectangular) hierarchy chart where depth maps to position along one axis and size maps to extent along the other. Like a sunburst unrolled into rectangles.',
  bestFor:
    'Same as sunburst/treemap but when you need readable labels at every level. File system browsers, org hierarchies, taxonomy breakdowns.',
  notFor:
    'Flat data, precise value comparison, non-hierarchical data.',
