...
export const beeswarmPattern: VisualizationPattern = {
  id: 'beeswarm',
  name: 'Beeswarm Plot',
  category: 'distribution',
  description:
    'Dots arranged along a single axis, jittered to avoid overlap. Shows individual data points while revealing distribution shape, clusters, and outliers.',
  bestFor:
    'Medium-sized datasets (20-500 rows) where individual points matter. Finding outliers, clusters, and gaps. Comparing distributions across a few groups.',
  notFor:
    'Very large datasets over 1000 points (too slow/cluttered), very small datasets under 10 (use strip plot).',
