...
export const areaPattern: VisualizationPattern = {
  id: 'area',
  name: 'Area Chart',
  category: 'time',
  description:
    'Filled area chart emphasizing volume and magnitude over time. Supports single-series, multi-series overlapping, stacked, and normalized (100%) stacked modes. Multiple interpolation curves: monotone (smooth), linear, step (staircase), curve (smooth rounded), cardinal, catmullRom. Configurable fill opacity.',
  bestFor:
    'Showing volume/magnitude over time. Revenue over time, website traffic, cumulative totals. Stacked: market share over time, revenue by product line. Step curve for discrete intervals (e.g. monthly billing). Normalized for proportion tracking.',
  notFor:
    'Comparing exact values across many series (overlapping areas obscure), non-temporal data, precise comparisons (use bar).',
