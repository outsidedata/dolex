...
export function renderLollipop(container: HTMLElement, spec: VisualizationSpec): void {
...
function renderHorizontal(
  ...
  const minVal = Math.min(0, d3.min(values) as number);
  const maxVal = Math.max(0, d3.max(values) as number);
  ...
  g.selectAll('.lollipop-hover')
    ...
    .attr('x', 0)
    .attr('y', (d: any) => yScale(String(d[categoryField])) - spacing / 2)
    ...
    .on('mouseover', function (event: MouseEvent, d: any) {
      ...
      g.selectAll('.lollipop-dot')
        .attr('opacity', (dd: any) => String(dd[categoryField]) === cat ? 1 : 0.25);
      g.selectAll('.lollipop-dot')
        .filter((dd: any) => String(dd[categoryField]) === cat)
        .attr('width', hoverSize * 2)
        .attr('height', hoverSize * 2)
        .attr('x', (dd: any) => xScale(Number(dd[valueField])) - hoverSize)
        .attr('y', (dd: any) => yScale(String(dd[categoryField])) - hoverSize);
    ...
    .on('mouseout', function () {
      g.selectAll('.lollipop-dot')
        ...
        .attr('width', r * 2)
        .attr('height', r * 2)
        .attr('x', (dd: any) => xScale(Number(dd[valueField])) - r)
        .attr('y', (dd: any) => yScale(String(dd[categoryField])) - r);
  ...
  g.selectAll('.lollipop-stem')
    ...
    .attr('y1', (d: any) => yScale(String(d[categoryField])))
    .attr('y2', (d: any) => yScale(String(d[categoryField])))
    .attr('stroke', (d: any) => colorScale(d[encoding.color?.field || categoryField]))
    .attr('stroke-width', 2)
  ...
  g.selectAll('.lollipop-dot')
    ...
    .attr('x', (d: any) => xScale(Number(d[valueField])) - r)
    .attr('y', (d: any) => yScale(String(d[categoryField])) - r)
    .attr('width', r * 2)
    .attr('height', r * 2)
    .attr('rx', 2)
    .attr('fill', (d: any) => colorScale(d[encoding.color?.field || categoryField]))
    .attr('stroke', '#0f1117')
  ...
  if (r >= 12) {
    g.selectAll('.lollipop-label')
      ...
      .attr('x', (d: any) => xScale(Number(d[valueField])))
      .attr('y', (d: any) => yScale(String(d[categoryField])))
      .attr('text-anchor', 'middle')
      .attr('dominant-baseline', 'central')
      .attr('fill', (d: any) => contrastText(colorScale(d[encoding.color?.field || categoryField])))
...
function renderVertical(
  ...
  const xAxis = g
    ...
    .call(
      d3
        ...
        .tickSize(0)
        .tickPadding(8)
        .tickFormat((d: string) => truncateLabel(d, 12))
    );
  ...
  g.selectAll('.lollipop-hover')
    ...
    .join('rect')
    .attr('class', 'lollipop-hover')
    .attr('x', (d: any) => xScale(String(d[categoryField])) - spacing / 2)
    .attr('y', 0)
    .attr('width', spacing)
    ...
    .on('mouseover', function (event: MouseEvent, d: any) {
      ...
      g.selectAll('.lollipop-dot')
        ...
        .attr('width', hoverSize * 2)
        .attr('height', hoverSize * 2)
        .attr('x', (dd: any) => xScale(String(dd[categoryField])) - hoverSize)
        .attr('y', (dd: any) => yScale(Number(dd[valueField])) - hoverSize);
    ...
    .on('mouseout', function () {
      g.selectAll('.lollipop-dot')
        ...
        .attr('width', r * 2)
        .attr('height', r * 2)
        .attr('x', (dd: any) => xScale(String(dd[categoryField])) - r)
        .attr('y', (dd: any) => yScale(Number(dd[valueField])) - r);
      g.selectAll('.lollipop-stem').attr('opacity', 1);
      hideTooltip(tooltip);
    });
  ...
  g.selectAll('.lollipop-stem')
    ...
    .join('line')
    .attr('class', 'lollipop-stem')
    .attr('x1', (d: any) => xScale(String(d[categoryField])))
    .attr('x2', (d: any) => xScale(String(d[categoryField])))
    .attr('y1', baselineY)
    .attr('y2', (d: any) => {
      const val = Number(d[valueField]);
  ...
  g.selectAll('.lollipop-dot')
    ...
    .join('rect')
    .attr('class', 'lollipop-dot')
    .attr('x', (d: any) => xScale(String(d[categoryField])) - r)
    .attr('y', (d: any) => yScale(Number(d[valueField])) - r)
    .attr('width', r * 2)
    .attr('height', r * 2)
    .attr('rx', 2)
    .attr('fill', (d: any) => colorScale(d[encoding.color?.field || categoryField]))
  ...
  if (r >= 12) {
    g.selectAll('.lollipop-label')
      ...
      .join('text')
      .attr('class', 'lollipop-label')
      .attr('x', (d: any) => xScale(String(d[categoryField])))
      .attr('y', (d: any) => yScale(Number(d[valueField])))
      .attr('text-anchor', 'middle')
      .attr('dominant-baseline', 'central')
      .attr('fill', (d: any) => contrastText(colorScale(d[encoding.color?.field || categoryField])))
      .attr('font-size', `${Math.min(10, r - 3)}px`)
