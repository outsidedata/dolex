 ...
 */
export function findNearestDateIndex(sortedDates: number[], targetTime: number): number {
 ...
 */
export function createCrosshairGroup(
  g: any,
  dims: { innerWidth: number; innerHeight: number },
): { crosshairLine: any; highlightDots: any; hoverArea: any } {
