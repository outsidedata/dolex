...
// ─── CHART MARGINS ────────────────────────────────────────────────────────────
//
// Margin presets for SVG charts. The `top` accommodates the title;
// `bottom` accommodates the x-axis label; `left` accommodates the y-axis label.
// `right` is minimal unless a legend is present.
...
} as const satisfies Record<string, ChartMargins>;
